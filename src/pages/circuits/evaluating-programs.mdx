...
<ArticleLayout title="Evaluating Programs & Teams" description="How to evaluate basketball programs when they reach out to recruit your kid." headings={getHeadings()}>
