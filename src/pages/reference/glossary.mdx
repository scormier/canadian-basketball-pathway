...
**Club basketball / Travel basketball:** Organized basketball outside of the school system. Teams are formed by clubs or programs (not schools), and typically practice year-round and travel to tournaments. This is the primary development vehicle for serious Canadian players.

**Open gym:** An informal, drop-in basketball session — usually at a local gym or training facility. Not organized team practice. Used for pickup games, extra reps, and exposure to other players. Not a recruiting venue.

**Showcase:** A basketball event specifically designed to put players in front of college coaches and scouts. Can be run by independent organizations, shoe brands, or recruiting services. Quality and legitimacy vary widely.

**CEBL (Canadian Elite Basketball League):** Canada's professional basketball league. Some USports and prep school graduates play in the CEBL.

**FIBA (International Basketball Federation):** The international governing body for basketball. Sets rules for international competition and age-group tournaments (U16, U17, U19). Uses birth-year cutoffs, not grade-based.

**Hudl:** A widely used video platform for sports film. College coaches are familiar with Hudl and it's a good option for hosting game film and highlights.

**Uncle Drew Circuit:** ANTA-backed grassroots circuit founded by Kyrie Irving in 2025. Ages 12U-17U, boys and girls.


## Recruiting & Eligibility

**D1 / D2 / D3 (Division I, II, III):** The three competitive divisions within the NCAA. D1 is the highest level with the most scholarships. D2 offers partial scholarships. D3 offers no athletic scholarships (financial aid is need-based or academic only). All three are legitimate college basketball.

**NAIA (National Association of Intercollegiate Athletics):** A separate governing body from the NCAA for smaller colleges and universities. Offers athletic scholarships with more flexible eligibility requirements than the NCAA. A legitimate option, especially for players who don't meet NCAA academic requirements.

**JUCO / NJCAA (Junior College):** Two-year colleges governed by the NJCAA (National Junior College Athletic Association). A common pathway for players who need to address academic eligibility gaps or develop before transferring to a 4-year NCAA program.

**NCSA (Next College Student Athlete):** The largest college recruiting network. Players create profiles with stats, video, and academic info. Coaches use it to search for prospects. Free and paid tiers available.

**Full ride / Full-ride scholarship:** A scholarship that covers everything — tuition, fees, room, board, and books. Available at NCAA D1 (13 per men's basketball team max). USports does NOT offer full-ride athletic scholarships.

**Walk-on:** A player who joins a college team without an athletic scholarship. Walk-ons earn their roster spot through tryouts or invitation. Some walk-ons eventually earn scholarships through performance ("preferred walk-on" may receive partial aid).

**Power Conference:** The top tier of NCAA D1 conferences — ACC, Big Ten, Big 12, Big East, SEC. Programs in these conferences have the largest budgets, most visibility, and strongest recruiting pipelines.

**High-major / Mid-major / Low-major:** Informal tiers within NCAA D1. High-major = Power Conference programs. Mid-major = strong non-Power Conference programs (e.g., Atlantic 10, WCC, Mountain West). Low-major = smaller D1 conferences. These are not official NCAA designations.

**AFA (Athletic Financial Award):** The term USports uses for athletic scholarships. Measured in "units" where 1 unit = 100% of tuition and fees. Does NOT cover room, board, or living expenses.
...
**+1 class year (CAN/US offset):** The convention where Canadian players are listed one year later in US recruiting databases than their Canadian graduation year. A Canadian Class of 2030 = US Class of 2031. The root cause is different school entry cutoff dates: Canada uses December 31 (entire birth year in one cohort), while most US states use September 1 (splitting a birth year across two graduating classes). US circuits use US graduation year to bracket players, so Canadian kids get slotted one year later. See the [Reclassification Guide](/schools/reclassification) for the full explanation.
...
**Prep year (post-grad year):** A year spent at a basketball prep school after graduating high school (grade 12). Common in the Canadian-to-NCAA pipeline. Does NOT start the NCAA eligibility clock. Provides an extra year of development and exposure. The prep year is a separate benefit from the +1 class year offset — it's not the cause of the class year difference.
